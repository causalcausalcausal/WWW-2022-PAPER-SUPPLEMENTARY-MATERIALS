...
test_result = pd.read_csv("output/UDCF_uplift_RCT",header=None,names=['pred1','pred2','pred3','pred4','pred5','pred6','pred7'])

test[['pred1','pred2','pred3','pred4','pred5','pred6','pred7']]=test_result
...
for budget in [300,400,500,600,700]:
    ...
    test_pivot.to_csv(str(budget)+'RCT_LBCF_final.csv')